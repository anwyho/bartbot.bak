...
from compose.utils.phrases.locales import (
...
class Phrase:
    ...
    def _get_or_load_phrases(self, phraseType: str) -> list:
        # NOTE: The global variables are used because they can be preserved from one lambda call to the next
    ...
    def get_attribute(self, phraseType: Optional[str] = None):
        return self._attributes.get(phraseType, []) if phraseType else self._attributes
