...
from compose.utils.phrases.emojis import emojis

from compose.utils.phrases.bartbot_en_US.attachment import *
...
# 5. Call compose.utils.phrases.emojis.print_all_emojis() for easily copy-paste
